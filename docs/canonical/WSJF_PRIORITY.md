...
|---|---:|---:|---:|---:|---:|---:|---|
| Pair-grid producer depth semantics / LRI origins / public names | 10 | 9 | 8 | 27 | 3 | **9.00** | Geometry-critical; storage, consumer formula, row matrix chain, tracked map-provider runtime path, descriptor custody boundary, four-zoom depth-builder handoff, `0x29ed90` worker formula, `StereoLayer<false>` index-5 source custody, generated reciprocal near/far lookup-vector mechanics, selected endpoint constants, internal count production, and the lookup's internal ray-depth hypothesis-grid role are proven; remaining work is source-index/source-record semantics, public units, and broader public calibration/LRI/protobuf origin/name mapping |
