...
- Image/merge effect of the proven post-mutation state, terminality of the mutation, and alternate routing outside the focused/tested sites remain unresolved.
...
| exact C6 routing | `N/A` | `N/A` | `PARTIAL`; focused active key-query identity and helper-body bookkeeping proven; post-mutation state consumer proven; `0x3c9540 -> 0xe6c30` candidate route zero-hit | `PARTIAL`; focused active key-query identity and helper-body bookkeeping proven; post-mutation state consumer proven; `0x3c9540 -> 0xe6c30` candidate route zero-hit | No; image/merge effect of the proven state, alternate routes, and terminality still unresolved |
