...
| exact C6 routing | `N/A` | `N/A` | `PARTIAL`; focused active key-query identity and helper-body bookkeeping proven | `PARTIAL`; focused active key-query identity and helper-body bookkeeping proven | No; downstream constructed-context consumers, alternate routes, and terminality still unresolved |
