...
| Q12 | 70mm/150mm CCM behavior verification | C18/R18 tested only at 28mm L16_02130; zoom-tier-specific CCM risk. | LLDB 0xbf4a0 + 0x350bc0 on L16_03434 70mm + L16_02285 150mm. **35mm partial close** (`q12_ics_kernel_35mm.md`, 2026-04-18 on L16_02951 35mm): 270 hits / 3 ptr-distinct / 2 value-distinct CCMs — matches 28mm topology. **28mm re-verify** in `q12_ics_kernel_28mm.md` (324 hits). 70mm/150mm still TBD. |
