...
typedef void (*executor_fn)(void *, void *, void *);

static uintptr_t libcp_base;
static void *executor_trampoline;
static pthread_mutex_t executor_mutex = PTHREAD_MUTEX_INITIALIZER;
...
static void executor_hook(void *context, void *unused, void *seed) {
    pthread_mutex_lock(&executor_mutex);
    ((executor_fn)executor_trampoline)(context, unused, seed);
...
static void install_executor_hook(void) {
    ...
    executor_trampoline = install_hook(0x6090, 12, (const void *)&executor_hook);
}
